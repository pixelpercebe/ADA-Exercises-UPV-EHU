...
PROCEDURE actualizar_ciudades_Prueba IS
...
BEGIN
   ...
   new_line;
   put_Line("Lista con las ciudades actualizadas");
   Actualizar_Ciudad(P1,Ciudad,"SanSebastian   ");
   Escribir_Personas(P1);
   ...
   new_line;
   put_Line("Lista con las ciudades actualizadas");
   Actualizar_Ciudad(P2,Ciudad,"SanSebastian   ");
   Escribir_Personas(P2);
   ...
   new_line;
   put_Line("Lista con las ciudades actualizadas");
   Actualizar_Ciudad(P3,Ciudad,"SanSebastian   ");
   Escribir_Personas(P3);
...
END actualizar_ciudades_Prueba;
